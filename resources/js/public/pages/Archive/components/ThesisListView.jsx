...
import { Typography, Tag, TagOutlined, UserOutlined, CalendarOutlined, BookOutlined } from '@ant-design/icons';
import dayjs from 'dayjs';

const { Title, Text } = Typography;

const ThesisListView = ({ selectedCategory, filteredTheses, onSelect, primaryColor }) => {
    return (

            ...
            <Row gutter={[48, 32]}>
                ...
                <Col xs={24} md={6} id="footer-guides">
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 13, display: 'flex', flexDirection: 'column', gap: 10 }}>
                        <li><Link to="/user-manual" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}><InfoCircleOutlined style={{ fontSize: 14 }} /> User Manual</Link></li>
                        <li><Link to="/research-policy" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}><InfoCircleOutlined style={{ fontSize: 14 }} /> Research Policy</Link></li>
                        <li><Link to="/submission-guide" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}><InfoCircleOutlined style={{ fontSize: 14 }} /> Submission Guide</Link></li>
                    </ul>
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 13, display: 'flex', flexDirection: 'column', gap: 8 }}>
                        <li><Link to="/research-policy" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none' }}>Terms of Use and Conditions</Link></li>
                        <li><Link to="/research-policy" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none' }}>Data Privacy Policy</Link></li>
                    </ul>
                </Col>
                ...
                <Col xs={24} md={5} id="footer-faq">
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 13, display: 'flex', flexDirection: 'column', gap: 10 }}>
                        <li><Link to="/general-access-faq" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}><QuestionCircleOutlined style={{ fontSize: 14 }} /> General Access FAQ</Link></li>
                        <li><Link to="/submission-faq" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}><QuestionCircleOutlined style={{ fontSize: 14 }} /> Submission FAQ</Link></li>
                        <li><Link to="/account-help" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}><QuestionCircleOutlined style={{ fontSize: 14 }} /> Account Help</Link></li>
                    </ul>
